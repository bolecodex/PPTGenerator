...
def generate_json(slide_number=5, word_content='', prompt="Generate a PPT of 5 slides", slideDeck = {"slide_number": float(5), "title": "", "content": "", "narration": ""}):
    messages = [
...
print(slides_data)
new_prompt="change the title of first slide into Weibo Zhao"
